...
// 2. Suppose q1 and q2 are Mongoose queries. You want to run q1 and print the result,
// and afterwards run q2 and print the result. Write some code to do this in two ways:
// without promises
...
//3. Suppose documents is an array of Mongoose documents that have been created but not saved.
